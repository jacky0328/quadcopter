...
const uint8_t HMC5883L_RA_ID_A = 0xA;
const uint8_t HMC5883L_RA_ID_B = 0xB;
const uint8_t HMC5883L_RA_ID_C = 0xC;
...
public:
    ...
    void calc_angle(double _x, double _y,s_rawData* rawData);
