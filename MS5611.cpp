...
void MS5611Class::getRawPressure_() {
    ...
    I2Cdev::readBytes(MS5611_ADDRESS, 0x00, 3,buf_);
...
void MS5611Class::reset_() {
    ...
    I2Cdev::writeBytes(MS5611_ADDRESS, resetCommand, 0, (uint8_t*)0);
}
